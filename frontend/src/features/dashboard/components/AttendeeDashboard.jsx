...
export default function AttendeeDashboard({ user, myTickets, onDownloadTicket }) {
  return (
    <>
      {/* Welcome Section */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-white border border-charcoal-light/10 rounded-2xl p-6 shadow-sm flex items-center gap-4 hover:border-coral/20 transition-all">
          ...
          <div>
            ...
            <h3 className="text-2xl font-black text-charcoal mt-0.5">$75.00</h3>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {myTickets.map(ticket => (
              ...
              >
                ...
                <div className="flex-grow p-6 flex flex-col justify-between space-y-6 border-b md:border-b-0 md:border-r border-dashed border-charcoal-light/20">
                  ...
                  <div className="flex items-center justify-between border-t border-charcoal-light/5 pt-4">
                    ...
                    <button 
                      ...
                      className="bg-stone-100 hover:bg-stone-200 text-charcoal text-xs font-bold px-3 py-2 rounded-lg transition-colors border border-charcoal-light/10 cursor-pointer"
                    >
                      💾 Download PDF
                    </button>
                  </div>
                ...
                {/* Cutout circles for ticket look (MD and up screen widths) */}
